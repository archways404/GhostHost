...
# Convert the original file to a base64-encoded string and save it
...
# Split the base64-encoded file into parts of 5MB each
...
# Combine the parts back into the full base64-encoded string and decode it
...
# Validate the base64-encoded file to ensure it can be decoded correctly
...
# Clear the output directory to ensure a clean working space
...
def main():
    ...
    base64_file_path = 'output/video64.txt'  # Path to save the base64-encoded file
    output_directory = os.path.dirname(base64_file_path)  # Directory to save parts and combined file
